...
<title>Epic Car Rental | Car Listing</title>
<!--Bootstrap -->
...
<?php $sql = "SELECT car.*,brand.brandname,brand.id as bid  from car join brand on brand.id=car.car_brand";
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Specify Your Choice </h5>
          </div>
